...
```mermaid
timeline
    title Develop history [2024-01-10 ~ 2024-01-14]
    ...
    2024-01-13: [✅]
            : [docs] DB설계
    2024-01-14: [✅]
            : [docs] DB설계, 및 분담 작업 시작
```

```mermaid
timeline
    title Develop history [2024-01-15 ~ 2024-01-21]
    2024-01-15: [✅] 기능 구현 시작
            : [docs] 기능 구현 1차
            : [Back] DB JPA로 구현 시작
	: [Front] 테마 디자인 구현
    ...
    2024-01-16: [✅] DB 설계 완료
            : [front] 테마 디자인 구현 
            : 🔨
            : [Back] DB JPA로 게시판 테이블과 멤버 테이블 구현
	: [Python] ...💦
    2024-01-17: [✅]
            : [front] 테마 디자인 구현
            : 🔨
	...
	: [Python] ...💦
    2024-01-18: [✅]
            : [front] 테마 디자인 구현, 로그인 회원가입 폼 구현
            : 🔨
            : [Back] DB JPA로 플레이리스트와 멤버 테이블 구현 중
	: [Python] 파이썬 초기 세팅
    2024-01-19: [✅]
            : [front] 로그인 정보창, 로그아웃 연결, 드롭다운 메뉴 구현 
            : 🔨
            : [Back] DB JPA로 플레이리스트와 멤버 테이블 구현 중
	: [Python] ...💦
    2024-01-20: [✅]
