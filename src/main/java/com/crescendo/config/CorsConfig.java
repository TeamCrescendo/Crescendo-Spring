...
public class CorsConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry
                ...
                .allowedOrigins("https://cresendo.site", "http://cresendo.site","http://localhost:3000", "http://crescendo-react-bucket.s3-website.ap-northeast-2.amazonaws.com") // 어떤 클라이언트를 허용할 지
